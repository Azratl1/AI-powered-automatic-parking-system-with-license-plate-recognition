...
class Config:
    ...
    YOLO_MODEL_PATH: str = 'D:\DOC\Plate_recognizing-main\runs\detect\runs_yolo\plate_detector_ru2\weights\best.pt'
    OCR_MODEL_PATH: str = 'D:\DOC\Plate_recognizing-main\ocr_checkpoints\ocr_best.pt'
